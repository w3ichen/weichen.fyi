    ...
    <PageBase>
      <Root maxWidth="md">
        ...
        <Typography variant="body1">
          <strong>
            Bachelor of Science in Computer Engineering Cooperative Program,
            Class of 2023
          </strong>
          <br />
          ...
          <br />
          <em>
            * Graduated on June 6, 2023 with Distinction and First Class
            Standing
          </em>
        </Typography>
        ...
        <OrderedList>
          ...
          <li>
            ...
            <strong>“Applying Graph Explanation to Operator Fusion.”</strong>{" "}
            The 60th Design Automation Conference (DAC 2023). July 2023.{" "}
          ...
          <li>
            ...
            <strong>“A Web-Based Ice Jam Profile Model.”</strong> 22nd Workshop
            on the Hydraulics of Ice Covered Rivers (CRIPE 2023). July 2023.{" "}
          ...
          <li>
            ...
            <strong>
              “Development of an Online Calculation Tool for Safety Evaluation
              of Pipes Subjected to Ground Movements.”
            </strong>{" "}
          ...
          <li>
            ...
            The Technology for Future and Ageing Pipelines Conference (TFAP
            2022). March 2022.
          </li>
          <li>
            Karen Dow, Samer Adeeb, Lindsey Westover, Yong Li, Weichen Qiu, et
            al.{" "}
            <strong>
